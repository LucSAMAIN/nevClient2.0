#! usr/env/bin python3
# nevclient.model.hardware.DAMQX.DAO
...
class DAO(DAQMXDynamicDevice, DAQMXAnalogDevice):
    """
    Defines the DAO type of DAQMX devices.
    Dynamic Analog Output.
    ...
    def __init__(self,
        ...
        self.logger = Logger(f"DAO id={id}")
